/* empty css                                */
import { c as createComponent, r as renderComponent, a as renderTemplate } from '../chunks/astro/server_DQB4DWMI.mjs';
import 'piccolore';
...
const $$Goagaci = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Go A\u011Fac\u0131" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "GameManager", null, { "client:only": "react", "allProblems": problemSet, "client:component-hydration": "only", "client:component-path": "/home/alikarakaya/Desktop/Agora/Agora_1.0.1/src/components/GameManager.jsx", "client:component-export": "default" })} ` })}`;
}, "/home/alikarakaya/Desktop/Agora/Agora_1.0.1/src/pages/goagaci.astro", void 0);

const $$file = "/home/alikarakaya/Desktop/Agora/Agora_1.0.1/src/pages/goagaci.astro";
const $$url = "/goagaci";
